...
export class MarketService {
  private readonly quotes: Quote[] = [
    { id: 1, symbol: 'AAPL', name: 'Apple Inc.', sector: 'Technology', price: 195.2, change: 1.4, changePercent: 0.72, volume: 52000000, marketCap: 3000000000000, status: AssetStatus.ACTIVE, updatedAt: new Date().toISOString() },
    { id: 2, symbol: 'BTC', name: 'Bitcoin', sector: 'Crypto', price: 103500, change: -890, changePercent: -0.85, volume: 12000000000, marketCap: 2040000000000, status: AssetStatus.ACTIVE, updatedAt: new Date().toISOString() },
    { id: 3, symbol: 'VOO', name: 'Vanguard S&P 500 ETF', sector: 'Index Fund', price: 512.44, change: 2.12, changePercent: 0.42, volume: 4100000, marketCap: 0, status: AssetStatus.ACTIVE, updatedAt: new Date().toISOString() },
  ];
